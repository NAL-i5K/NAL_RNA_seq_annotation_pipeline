...
time.sleep(0.7)
proc_efilter = subprocess.Popen(['efilter', '-query', 'rna seq[stra] AND Transcriptomic[src] NOT([library layout single] AND ls454[platform]) NOT PACBIO_SMRT[platform]'], stdin=proc_elink.stdout, stdout=subprocess.PIPE)
time.sleep(0.7)
